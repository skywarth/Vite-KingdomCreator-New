...
export let Work_Card:DigitalCard = {  id: "priXnce", frenchName: "",  artwork:"",
    
text_html: '<div class="card-text" style="top:05px;">\
<div class="card-text-vp-icon-container" style="display:inline; transform:scale(0.8); top:10px;left:125px;">\
