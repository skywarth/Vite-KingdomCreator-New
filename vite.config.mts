...
import { viteStaticCopy } from './node_modules/vite-plugin-static-copy/dist/index'
...
export default defineConfig(({ mode }) => {
  return {
    ...
    plugins: [
      viteStaticCopy({
        targets: [ { src: normalizePath(path.resolve(__dirname, 'styles/normalize-v8.css')), dest: '' } ]
      }),
