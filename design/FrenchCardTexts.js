...
FrenchCardTexts[CardNames.COUNCILROOM] = "|+4 Cartes|//|+1 Achat|////Tous vos adversaires//piochent une carte.";
...
FrenchCardTexts[CardNames.THRONEROOM] = "Vous pouvez jouer une carte//Action de votre main deux fois.";
...
FrenchCardTexts[CardNames.MININGVILLAGE] = "|+1 Carte|//|+2 Actions|////Vous pouvez \xE9carter cette carte// pour +[2].";
...
FrenchCardTexts[CardNames.SECRETPASSAGE] = "|+2 Cartes|//|+1 Action|////Prenez une carte de votre main et//placez-la o\xF9 vous voulez dans//votre pioche.";
FrenchCardTexts[CardNames.SHANTYTOWN] = "|+2 Actions|////D\xE9voilez votre main.//Si vous n'avez aucune carte//Action en main, |+2 Cartes|.";
...
FrenchCardTexts[CardNames.TRADINGPOST] = "\xC9cartez 2 cartes de votre main.//Dans ce cas, recevez un Argent//dans votre main.";
...
FrenchCardTexts[CardNames.WISHINGWELL] = "|+1 Carte|//|+1 Action|////Nommez une carte, puis d\xE9voilez la//carte du haut de votre pioche. Si le//nom correspond, prenez-la en main.";
...
FrenchCardTexts[CardNames.FISHINGVILLAGE] = "|+2 Actions|//|+[1]|////Au d\xE9but de votre prochain tour ://|+1 Action| et |+|[1]";
FrenchCardTexts[CardNames.GHOSTSHIP] = "|+2 Cartes|////Tous vos adversaires ayant au//moins 4 cartes en main placent//des cartes de leur main sur leur//pioche jusqu'\xE0 avoir 3 cartes//en main.";
...
FrenchCardTexts[CardNames.MERCHANTSHIP] = "Maintenant et au d\xE9but de//votre prochain tour, |+|[2].";
FrenchCardTexts[CardNames.NATIVEVILLAGE] = "|+2 Actions|////Choisissez : placez la carte du haut//de votre pioche, face cach\xE9e, sur//votre plateau Village indig\xE8ne//vous pouvez consulter ces cartes//\xE0 tout moment) ; ou prenez en//main toutes les cartes du plateau.";
...
FrenchCardTexts[CardNames.PEARLDIVER] = "|+1 Carte|//|+1 Action|////Consultez la carte du bas de//votre pioche. Vous pouvez la//placer sur le haut.";
FrenchCardTexts[CardNames.PIRATESHIP] = "Choisissez : +[1] par jeton Pi\xE8ce//sur votre plateau Bateau pirate ; ou//tous vos adversaires d\xE9voilent les 2//premi\xE8res cartes de leur pioche, \xE9car-//tent un Tr\xE9sor d\xE9voil\xE9 de votre choix//et d\xE9faussent le reste, et si au moins un//Tr\xE9sor a \xE9t\xE9 \xE9cart\xE9, placez un jeton//Pi\xE8ce sur votre plateau Bateau pirate.";
FrenchCardTexts[CardNames.SALVAGER] = "|+1 Achat|////\xC9cartez une carte de votre main.//|+|[1] par [1] de son co\xFBt.";
FrenchCardTexts[CardNames.SEAHAG] = "Tous vos adversaires d\xE9faussent//la carte du haut de leur pioche,//puis re\xE7oivent une Mal\xE9diction//sur leur pioche.";
...
FrenchCardTexts[CardNames.TREASUREMAP] = "\xC9cartez ceci et une Carte aux//tr\xE9sors de votre main. Si vous//avez \xE9cart\xE9 deux Cartes aux//tr\xE9sors, recevez 4 Ors sur//votre pioche.";
...
FrenchCardTexts[CardNames.PHILOSOPHERSSTONE] = "Comptez le nombre de cartes de//votre pioche et de votre d\xE9fausse.//+[1] par tranche de 5 cartes//au total (arrondi inf\xE9rieurement).";
...
FrenchCardTexts[CardNames.COUNTINGHOUSE] = "Regardez dans votre d\xE9fausse,//d\xE9voilez autant de Cuivres que//vous le voulez, et prenez-les//en main.";
...
FrenchCardTexts[CardNames.GRANDMARKET] = "|+1 Carte|//|+1 Action|//|+1 Achat|//|+[2]|//---//Vous ne pouvez pas acheter cette//carte si vous avez un Cuivre en jeu.";
...
FrenchCardTexts[CardNames.KINGSCOURT] = "Vous pouvez jouer trois fois//une carte Action de votre main.";
...
FrenchCardTexts[CardNames.ROYALSEAL] = "[!2]//---//Tant que vous avez cette carte en jeu,//quand vous recevez une carte, vous//pouvez la placer sur votre pioche.";
...
FrenchCardTexts[CardNames.TRADEROUTE] = "|+1 Achat|////\xC9cartez une carte de votre main. |+|[1] par//Pi\xE8ce sur le plateau Route Commerciale.//---//Mise en place : placez une Pi\xE8ce sur chaque//pile de cartes Victoire de la r\xE9serve; d\xE9pla-//cez-la vers le plateau Route Commerciale//lorsqu'une carte de cette pile est re\xE7ue.";
...
FrenchCardTexts[CardNames.WORKERSVILLAGE] = "|+1 Carte|//|+2 Actions|//|+1 Achat|";
FrenchCardTexts[CardNames.BAGOFGOLD] = "|+1 Action|////Recevez un Or sur votre pioche.//%(Ne fait pas partie de la r\xE9serve.)%";
...
FrenchCardTexts[CardNames.FARMINGVILLAGE] = "|+2 Actions|////D\xE9voilez des cartes de votre pioche//jusqu'\xE0 d\xE9voiler une carte Tr\xE9sor//ou Action. Prenez en main cette//carte et d\xE9faussez les autres.";
...
FrenchCardTexts[CardNames.FORTUNETELLER] = "+[2]//////Tous vos adversaires d\xE9voilent des//cartes de leur pioche jusqu'\xE0 d\xE9voiler//une carte Victoire ou une//Mal\xE9diction. Ils la replacent et//d\xE9faussent les autres cartes.";
...
FrenchCardTexts[CardNames.HORSETRADERS] = "|+1 Achat|//|+[3]|//D\xE9faussez deux cartes.//---//Quand un adversaire joue une carte//Attaque, vous pouvez d'abord mettre de//c\xF4t\xE9 cette carte de votre main. Dans ce//cas, au d\xE9but de votre prochain tour,//+|1 Carte| et reprenez en main cette carte.";
FrenchCardTexts[CardNames.HORNOFPLENTY] = "Recevez une carte co\xFBtant//jusqu'\xE0 [1] par carte en jeu//de nom diff\xE9rent (y compris cette//carte). Si la carte re\xE7ue est une//carte Victoire, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.HUNTINGPARTY] = "|+1 Carte|//|+1 Action|////D\xE9voilez votre main. D\xE9voilez des//cartes de votre pioche jusqu'\xE0 d\xE9voiler//une carte dont vous n'ayez pas un//exemplaire en main. Prenez-la//en main et d\xE9faussez le reste.";
...
FrenchCardTexts[CardNames.TRUSTYSTEED] = "Choisissez deux : |+2 Cartes|;//|+2 Actions|; +[2]; recevez 4//Argents et mettez votre pioche//dans votre d\xE9fausse. Les choix//doivent \xEAtre diff\xE9rents.//%(Ne fait pas partie de la r\xE9serve.)%";
FrenchCardTexts[CardNames.YOUNGWITCH] = "|+2 Cartes|////D\xE9faussez 2 cartes. Tous vos adversaires//re\xE7oivent une Mal\xE9diction a moins//de d\xE9voiler une carte Fl\xE9au de leur main.//---//Mise en place : ajoutez \xE0 la r\xE9serve une pile//Royaume suppl\xE9mentaire co\xFBtant [2] ou [3].//Les cartes de cette pile sont les cartes Fl\xE9au.";
FrenchCardTexts[CardNames.BORDERVILLAGE] = "|+1 Carte|//|+2 Actions|//---//Quand vous recevez cette carte,//recevez une carte moins ch\xE8re.";
...
FrenchCardTexts[CardNames.FOOLSGOLD] = "Si c'est la premi\xE8re fois que//que vous jouez un Or des Fous \xE0//ce tour, +[1]. Sinon, +[4].//---//Quand un autre joueur re\xE7oit une//Province, vous pouvez \xE9carter//cette carte de votre main, pour//recevoir un Or sur votre pioche.";
...
FrenchCardTexts[CardNames.ILLGOTTENGAINS] = "[!1]////Vous pouvez recevoir un Cuivre en main.//---//Lorsque vous recevez cette carte, tous//vos adversaires re\xE7oivent une Mal\xE9diction.";
...
FrenchCardTexts[CardNames.JACKOFALLTRADES] = "Recevez un Argent.////Consultez la carte du haut de votre//pioche; vous pouvez la d\xE9fausser.////Piochez jusqu'\xE0 avoir 5 cartes//en main.////Vous pouvez \xE9carter une carte//non-Tr\xE9sor de votre main.";
...
FrenchCardTexts[CardNames.SILKROAD] = "Vaut {1} pour chaque 4 cartes//Victoire que vous avez//(arrondi inf\xE9rieurement).";
FrenchCardTexts[CardNames.SPICEMERCHANT] = "Vous pouvez \xE9carter une carte//Tr\xE9sor de votre main pour choisir//|+2 Cartes| et| +1 Action|;//ou| +|[2] et| +1 Achat|.";
...
FrenchCardTexts[CardNames.ABANDONEDMINE] = "|+|[1]";
...
FrenchCardTexts[CardNames.BANDOFMISFITS] = "Jouez une carte Action non-Ordre de//la r\xE9serve moins ch\xE8re que celle-ci,//en la laissant dans la r\xE9serve.";
FrenchCardTexts[CardNames.BANDITCAMP] = "|+1 Carte|//|+2 Actions|////Recevez un Butin//de la pile des Butins.";
...
FrenchCardTexts[CardNames.DAMEANNA] = "Vous pouvez \xE9carter jusqu'\xE0//deux cartes de votre main.////Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.DAMEJOSEPHINE] = "{!2}//---//Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.DAMEMOLLY] = "|+2 Actions|////Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.DAMENATALIE] = "Recevez une carte//co\xFBtant jusqu'\xE0 [3].////Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.DAMESYLVIA] = "+[2]////Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.DEATHCART] = "Vous pouvez \xE9carter cette carte//ou une carte Action de votre main//pour +[5].//---//Lorsque vous recevez cette carte,//recevez 2 ruines.";
...
FrenchCardTexts[CardNames.HUNTINGGROUNDS] = "|+4 Cartes|//---//Quand vous \xE9cartez cette carte,//recevez un Duch\xE9 ou 3 Domaines.";
...
FrenchCardTexts[CardNames.JUNKDEALER] = "|+1 Carte|//|+1 Action|//|+[1]|////\xC9cartez une carte de votre main.";
...
FrenchCardTexts[CardNames.MARKETSQUARE] = "|+1 Carte|//|+1 Action|//|+1 Achat|//---//Quand une de vos cartes est \xE9cart\xE9e,//vous pouvez d\xE9fausser cette carte//de votre main pour recevoir un Or.";
...
FrenchCardTexts[CardNames.OVERGROWNESTATE] = "{!0}//---//Quand vous \xE9cartez cette carte, //|+1 Carte|.";
...
FrenchCardTexts[CardNames.POORHOUSE] = "+[4]////D\xE9voilez votre main. -[1] par//carte Tr\xE9sor en main.//(Vous ne pouvez pas descendre//en dessous de [0].)";
...
FrenchCardTexts[CardNames.RUINEDLIBRARY] = "|+1 Carte|";
FrenchCardTexts[CardNames.RUINEDMARKET] = "|+1 Achat|";
FrenchCardTexts[CardNames.RUINEDVILLAGE] = "|+1 Action|";
...
FrenchCardTexts[CardNames.SIRBAILEY] = "|+1 Carte|//|+1 Action|////Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.SIRDESTRY] = "|+2 Cartes|////Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.SIRMARTIN] = "|+2 Achats|////Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.SIRMICHAEL] = "Tous vos adversaires d\xE9faussent//jusqu'\xE0 avoir 3 cartes en main.////Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.";
FrenchCardTexts[CardNames.SIRVANDER] = "Tous vos adversaires d\xE9voilent les//deux cartes du haut de leur pioche, en//\xE9cartent une co\xFBtant entre [3] et [6],//et d\xE9faussent le reste. Si un Chevalier//a \xE9t\xE9 \xE9cart\xE9, \xE9cartez cette carte.//---//Quand vous \xE9cartez cette carte,//recevez un Or.";
...
FrenchCardTexts[CardNames.WANDERINGMINSTREL] = "|+1 Carte|//|+2 Actions|////D\xE9voilez les 3 premi\xE8res cartes//de votre pioche. Replacez les//cartes Action dans l'ordre de votre//choix et d\xE9faussez le reste.";
...
FrenchCardTexts[CardNames.CANDLESTICKMAKER] = "|+1 Action|//|+1 Achat|//|+1 Coffres|";
...
FrenchCardTexts[CardNames.MERCHANTGUILD] = "|+1 Achat|//|+[1]|////A ce tour, \xE0 la fin de//votre phase Achat, |+1 Coffres|//par carte re\xE7ue durant cette phase";
...
FrenchCardTexts[CardNames.BRIDGETROLL] = "Tous vos adversaires prennent leur//jeton -[1]. Maintenant et au d\xE9but//de votre prochain tour : |+1 Achat|.//Durant ce tour et votre prochain tour,//les cartes co\xFBtent [1] de moins.";
FrenchCardTexts[CardNames.CARAVANGUARD] = "|+1 Carte|//|+1 Action|////Au d\xE9but de votre prochain tour, |+|[1].//---//Quand un adversaire joue une carte//Attaque, vous pouvez d'abord jouer//cette carte de votre main.";
...
FrenchCardTexts[CardNames.COINOFTHEREALM] = "[!1]////Quand vous jouez cette carte,//placez-la sur votre plateau Taverne.//---//Imm\xE9diatement apr\xE8s avoir fini de//jouer une carte Action, vous pouvez//recourir \xE0 cette carte pour |+2 Actions|.";
...
FrenchCardTexts[CardNames.DISTANTLANDS] = "Placez cette carte//sur votre plateau taverne.//---//Cette carte vaut {4} si elle est//sur votre plateau Taverne \xE0 la fin//de la partie ({0} sinon).";
...
FrenchCardTexts[CardNames.HAUNTEDWOODS] = "Au d\xE9but de votre prochain tour,//|+3 Cartes|//Jusqu'\xE0 votre prochain tour, quand//un adversaire re\xE7oit une carte//qu'il a achet\xE9e, il place//sa main sur sa pioche dans//l'ordre de son choix.";
...
FrenchCardTexts[CardNames.LOSTCITY] = "|+2 Cartes|//|+2 Actions|//---//Quand vous recevez cette carte, tous//vos adversaires piochent une carte.";
...
FrenchCardTexts[CardNames.ROYALCARRIAGE] = "|+1 Action|////Placez cette carte sur//votre plateau Taverne.//---//Imm\xE9diatement apr\xE8s avoir fini de//jouer une carte Action, si elle est//encore en jeu, vous pouvez recourir//\xE0 cette carte pour la rejouer.";
...
FrenchCardTexts[CardNames.SWAMPHAG] = "Au d\xE9but de votre prochain tour,//+[3].//Jusqu'\xE0 votre prochain tour, quand//un adversaire re\xE7oit une carte qu'il//a achet\xE9e, il re\xE7oit une Mal\xE9diction.";
...
FrenchCardTexts[CardNames.TREASURETROVE] = "[!2]////Quand vous jouez cette carte,//recevez un Or et un Cuivre.";
FrenchCardTexts[CardNames.TREASUREHUNTER] = "|+1 Action|//|+[1]|//---//Recevez un Argent par carte re\xE7ue par//le joueur \xE0 votre droite \xE0 son dernier tour.////Quand vous d\xE9faussez cette carte//de votre zone de jeu, vous pouvez//l'\xE9changer contre une Guerri\xE8re.//%(Ne fait pas partie de la r\xE9serve.)%";
...
FrenchCardTexts[CardNames.WINEMERCHANT] = "|+1 Achat|//|+[4]|//---//Placez cette carte//sur votre plateau Taverne.////A la fin de votre phase Achat, si vous avez//au moins [2] non d\xE9pens\xE9s, vous pouvez//d\xE9fausser cette carte de votre Taverne.";
...
FrenchCardTexts[CardNames.BUSTLINGVILLAGE] = "|+1 Carte|//|+3 Actions|//////Vous pouvez d\xE9voiler//un Colons de votre d\xE9fausse//et le prendre en main.";
...
FrenchCardTexts[CardNames.HUMBLECASTLE] = "[!1]//---//Vaut {1} par Ch\xE2teau//que vous avez.";
FrenchCardTexts[CardNames.CRUMBLINGCASTLE] = "{!1}//---//Lorsque vous recevez ou \xE9cartez cette//carte, +{1} et recevez un Argent.";
FrenchCardTexts[CardNames.SMALLCASTLE] = "{!2}//---//\xC9cartez cette carte ou//un Ch\xE2teau de votre main.//Dans ces cas, recevez un Ch\xE2teau.";
FrenchCardTexts[CardNames.HAUNTEDCASTLE] = "{!2}//---//Lorsque vous recevez cette carte//pendant votre tour, recevez un Or//et tous vos adversaires ayant//au moins 5 cartes en main//en placent 2 sur leur pioche.";
FrenchCardTexts[CardNames.OPULENTCASTLE] = "{!3}//---//D\xE9faussez autant de cartes//Victoire que souhait\xE9, d\xE9voil\xE9es.//+[!2] par carte d\xE9fauss\xE9e.";
FrenchCardTexts[CardNames.SPRAWLINGCASTLE] = "{!4}//---//Lorsque vous recevez cette carte,//recevez un Duch\xE9 ou 3 Domaines.";
FrenchCardTexts[CardNames.GRANDCASTLE] = "{!5}//---//Lorsque vous recevez cette carte,//d\xE9voilez votre main. +{1} par carte//Victoire en main et/ou en jeu.";
FrenchCardTexts[CardNames.KINGSCASTLE] = "Vaut {2} par Ch\xE2teau//que vous avez.";
...
FrenchCardTexts[CardNames.CHARIOTRACE] = "|+1 Action|////D\xE9voilez la carte du haut de votre//pioche et prenez-la en main. Le//joueur \xE0 votre gauche d\xE9voile la//carte du haut de sa pioche. Si votre//carte co\xFBte plus, +[1] et {+1}.";
FrenchCardTexts[CardNames.CITYQUARTER] = "|+2 Actions|//////D\xE9voilez votre main. |+1 Carte|//par carte Action d\xE9voil\xE9e.";
...
FrenchCardTexts[CardNames.FARMERSMARKET] = "|+1 Achat|////S'il y a {4} ou plus sur la pile//des March\xE9s Agricoles, prenez-les//et \xE9cartez cette carte. Sinon,//ajoutez {1} \xE0 la pile, puis//+[1] par {1} sur la pile.";
...
FrenchCardTexts[CardNames.ROYALBLACKSMITH] = "|+5 Cartes|//////D\xE9voilez votre main ;//d\xE9faussez les Cuivres.";
...
FrenchCardTexts[CardNames.WILDHUNT] = "Choisissez : |+3 Cartes| et//ajoutez {1} \xE0 la pile des//Chasses Fantastiques ; ou//recevez un Domaine, et dans//ce cas prenez les {} de la pile.";
FrenchCardTexts[CardNames.BARD] = "|+|[2]//Appliquez une Aubaine.";
FrenchCardTexts[CardNames.BLESSEDVILLAGE] = "|+1 Carte|//|+2 Actions|//---//Quand vous recevez cette carte, prenez//une Aubaine. Appliquez-la maintenant//ou au d\xE9but de votre prochain tour.";
...
FrenchCardTexts[CardNames.CURSEDVILLAGE] = "|+2 Actions|////Piochez jusqu'\xE0 avoir 6 cartes//en main.//---//Quand vous recevez cette carte,//appliquez un Sortil\xE8ge.";
FrenchCardTexts[CardNames.DENOFSIN] = "Au d\xE9but de votre prochain tour : //|+2 Cartes|.//---//Cette carte est re\xE7ue en main//(et non dans la d\xE9fausse).";
FrenchCardTexts[CardNames.DEVILSWORKSHOP] = "Si le nombre de cartes que vous//avez re\xE7ue(s) \xE0 ce tour est ://|2+: |recevez un Farfadet de sa pile ;//|1: |recevez une carte co\xFBtant jusqu'\xE0 [4];//|0: |recevez un Or.";
...
FrenchCardTexts[CardNames.FAITHFULHOUND] = "|+2 Cartes|//---//Quand vous d\xE9faussez cette carte//en dehors de la phase Ajustement,//vous pouvez la mettre de c\xF4t\xE9, et la//prendre en main \xE0 la fin de votre tour.";
...
FrenchCardTexts[CardNames.GHOSTTOWN] = "Au d\xE9but de votre prochain//tour : |+1 Carte |et |+1 Action|.//---//Cette carte est re\xE7ue en main//(et non dans la d\xE9fausse).";
...
FrenchCardTexts[CardNames.NIGHTWATCHMAN] = "Consultez les 5 premi\xE8res cartes de//votre pioche, d\xE9faussez-en autant//que souhait\xE9, et replacez le reste//dans l'ordre de votre choix.//---//Cette carte est re\xE7ue en main//(et non dans la d\xE9fausse).";
...
FrenchCardTexts[CardNames.SACREDGROVE] = "|+1 Achat|//|+[3]|////Appliquez une Aubaine. Si elle//ne donne pas +[1], tous vos//adversaires peuvent l'appliquer.";
FrenchCardTexts[CardNames.SECRETCAVE] = "|+1 Carte|//|+1 Action|////Vous pouvez d\xE9fausser 3 cartes.//Dans ce cas, au d\xE9but de votre//prochain tour, +[3].//%%(Patrimoine : Lampe magique)%%";
...
FrenchCardTexts[CardNames.TRAGICHERO] = "|+3 Cartes|//|+1 Achat|//////Si vous avez en main 8 cartes ou//plus (apr\xE8s avoir pioch\xE9), \xE9cartez//cette carte et recevez une//carte Tr\xE9sor.";
...
FrenchCardTexts[CardNames.CURSEDGOLD] = "[!3]////Quand vous jouez cette carte,//recevez une Mal\xE9diction.";
FrenchCardTexts[CardNames.GOAT] = "[!1]////Quand vous jouez cette carte,//vous pouvez \xE9carter une carte//de votre main.";
FrenchCardTexts[CardNames.HAUNTEDMIRROR] = "[!1]//---//Quand vous \xE9cartez cette carte,//vous pouvez d\xE9fausser une carte//Action pour recevoir un Fant\xF4me//de sa pile.";
FrenchCardTexts[CardNames.LUCKYCOIN] = "[!1]////Quand vous jouez cette carte,//recevez un Argent.";
FrenchCardTexts[CardNames.MAGICLAMP] = "[!1]////Quand vous jouez cette carte, si vous//avez au moins 6 cartes avec un unique//exemplaire en jeu, \xE9cartez cette carte.//Dans ce cas, recevez 3 V\u0153ux.";
...
FrenchCardTexts[CardNames.WILLOWISP] = "|+1 Carte|//|+1 Action|////D\xE9voilez la carte du haut de//votre pioche. Si elle co\xFBte [2]//ou moins, prenez-la en main.//%(Ne fait pas partie de la r\xE9serve.)%";
...
FrenchCardTexts[CardNames.ZOMBIEAPPRENTICE] = "Vous pouvez \xE9carter une carte//Action de votre main pour//|+3 Cartes |et |+1 Action|.";
FrenchCardTexts[CardNames.ZOMBIEMASON] = "\xC9cartez la carte du dessus de votre//pioche. Vous pouvez recevoir une//carte co\xFBtant jusqu'\xE0 [1] de plus.";
FrenchCardTexts[CardNames.ZOMBIESPY] = "|+1 Carte|//|+1 Action|////Consultez la carte du dessus de//votre pioche. D\xE9faussez-la ou //replacez-la.";
FrenchCardTexts[CardNames.ACTINGTROUPE] = "|+4 Villageois|//\xC9cartez cette carte.";
FrenchCardTexts[CardNames.BORDERGUARD] = "|+1 Action|////D\xE9voilez les 2 premi\xE8res cartes//de votre pioche. Prenez-en une//en main et d\xE9faussez l'autre. Si//les deux \xE9taient des cartes Action,//prenez la Lanterne ou la Corne.";
FrenchCardTexts[CardNames.CARGOSHIP] = "|+[2]|////Une fois \xE0 ce tour, quand vous//recevez une carte, vous pouvez la//mettre de c\xF4t\xE9 face visible (sur//cette carte). Au d\xE9but de votre//prochain tour, prenez-la en main.";
...
FrenchCardTexts[CardNames.FLAGBEARER] = "|+[2]|//---//Quand vous recevez ou \xE9cartez//cette carte, prenez le Drapeau.";
...
FrenchCardTexts[CardNames.MOUNTAINVILLAGE] = "|+2 Actions|////Consultez votre d\xE9fausse et//prenez-en une carte en main ; si//vous ne pouvez pas, |+1 Carte|.";
...
FrenchCardTexts[CardNames.SILKMERCHANT] = "|+2 Cartes|//|+1 Achat|//---//Quand vous recevez//ou \xE9cartez cette carte,//|+1 Coffres| et |+1 Villageois|.";
FrenchCardTexts[CardNames.OLDWITCH] = "|+3 Cartes|////Tous vos adversaires//re\xE7oivent une Mal\xE9diction//et peuvent \xE9carter une//Mal\xE9diction de leur main.";
...
FrenchCardTexts[CardNames.WALLEDVILLAGE] = "|+1 Carte|//|+2 Actions|//---//Au d\xE9but de la phase Ajustement, si//vous avez cette carte et au plus une//autre carte Action en jeu, vous pouvez//remettre cette carte sur votre pioche.";
...
FrenchCardTexts[CardNames.BLACKCAT] = "|+2 Cartes|//Si ce n'est pas votre tour, tous vos//adversaires re\xE7oivent une Mal\xE9diction.//---//Quand un adversaire re\xE7oit une//carte Victoire, vous pouvez jouer//cette carte depuis votre main.";
...
FrenchCardTexts[CardNames.CAMELTRAIN] = "Exilez une carte non-Victoire//depuis la r\xE9serve.//---//Quand vous recevez cette carte,//exilez un Or depuis la r\xE9serve.";
...
FrenchCardTexts[CardNames.SNOWYVILLAGE] = "|+1 Carte|//|+4 Actions|//|+1 Achat|////Ignorez tout effet |+Action(s)|//que vous recevrez ce tour.";
FrenchCardTexts[CardNames.STOCKPILE] = "[!3]////|+1 Achat|////Quand vous jouez cette carte//exilez-la.";
FrenchCardTexts[CardNames.BOUNTYHUNTER] = "|+1 Action|////Exilez une carte de votre main.//Si vous n'en aviez pas//d'exemplaire en exil, |+|[3].";
...
FrenchCardTexts[CardNames.VILLAGEGREEN] = "Maintenant ou au d\xE9but//de votre prochain tour,//|+1 Carte| et |+2 Actions.|//---//Quand vous d\xE9faussez cette//carte en dehors de votre phase//Ajustement, vous pouvez//la d\xE9fausser pour la jouer.";
...
FrenchCardTexts[CardNames.HUNTINGLODGE] = "|+1 Carte|//|+2 Actions|////Vous pouvez d\xE9fausser votre//main pour |+5 Cartes|.";
...
FrenchCardTexts[CardNames.ANIMALFAIR] = "|+[4]|////|+1 Achat| par pile vide//de la R\xE9serve.//---//Au lieu de payer le co\xFBt de//cette carte, vous pouvez \xE9carter//une carte Action de votre main.";
...
FrenchCardTexts[CardNames.MERCHANTCAMP] = "|+2 Actions|//+[1]//---//Quand vous défaussez cette carte//de votre zone de jeu, vous pouvez//la placer sur votre pioche.";
...
FrenchCardTexts[CardNames.CAPITALCITY] = "|+1 Carte|//|+2 Actions|//Vous pouvez défausser 2 cartes//pour +[2]. Vous pouvez payer [2]//pour |+2 Cartes|.";
...
FrenchCardTexts[CardNames.ROYALGALLEY] = "|+1 Carte|//Vous pouvez jouer une carte//Action non-Durée de votre main.//Mettez-la de côté;//dans ce cas, jouez-la//au début de votre prochain tour.";
...
FrenchCardTexts[CardNames.HERBGATHERER] = "|+1 Achat|//Placez votre pioche dans//votre défausse. Consultez-la.//Vous pouvez jouer un Trésor//depuis votre défausse. Vous//pouvez tourner les Augures.";
...
FrenchCardTexts[CardNames.BATTLEPLAN] = "|+1 Carte|//|+1 Action|//Vous pouvez dévoiler une//carte Attaque de votre main//pour |+1 Carte|. Vous pouvez//tourner une pile de la Réserve.";
...
FrenchCardTexts[CardNames.HILLFORT] = "Recevez une carte coûtant//jusqu'à [4]. Choisissez ://prenez-la en main;//ou |+1 Carte| et |+1 Action|.";
FrenchCardTexts[CardNames.STRONGHOLD] = "Choisissez : |+|[3];//ou au début de votre//prochain tour, |+3 Cartes.|//---//{!2}";
FrenchCardTexts[CardNames.OLDMAP] = "|+1 Carte|//|+1 Action|//Défaussez une carte. |+1 Carte|.//Vous pouvez tourner les Odyssées.";
...
FrenchCardTexts[CardNames.SUNKENTREASURE] = "Recevez une carte Action//dont vous n'avez pas//d'exemplaire en jeu.";
FrenchCardTexts[CardNames.DISTANTSHORE] = "|+2 Cartes|//|+1 Action|//Recevez un Domaine.//---//{!2}";
FrenchCardTexts[CardNames.TOWNCRIER] = "Choisissez une option: |+|[2];// ou recevez un Argent;// ou |+1 Carte| et |+1 Action|.////Vous pouvez tourner//les Citoyens. ";
...
FrenchCardTexts[CardNames.SEACHART] = "|+1 Carte|//|+1 Action|//Dévoilez la carte du haut de votre pioche.//Si vous en avez un exemplaire//en jeu, prenez-là en main.";
FrenchCardTexts[CardNames.ASTROLABE] = "Maintenant et au début//de votre prochain tour :////[!1]//|+1 Achat|";
FrenchCardTexts[CardNames.TIDEPOOLS] = "|+3 Cartes|//|+1 Action|//Au début de votre prochain//tour, défaussez 2 cartes.";
FrenchCardTexts[CardNames.SEAWITCH] = "|+2 Cartes|//Tous vos adversaires reçoivent//une Malédiction. Au début de votre//prochain tour, |+2 Cartes|,//puis défaussez 2 cartes.";
...
FrenchCardTexts[CardNames.CRYSTALBALL] = "[!1]//Consultez la carte du haut de//votre pioche. Vous pouvez l'écarter,//la défausser, ou, si c'est une//Action on un Trésor, la jouer.";
FrenchCardTexts[CardNames.MAGNATE] = "Dévoilez votre main.//|+1 Carte| par Trésor dévoilé.";
FrenchCardTexts[CardNames.WARCHEST] = "Le jouer à votre gauche nomme//une carte. Recevez une carte//coûtant jusqu'à [5] qui//n'a pas été nommée à ce tour//pour les Trésors de guerre.";
...
FrenchCardTexts[CardNames.GUARDDOG] = "|+2 Cartes|//Si vous avez en main 5 cartes//ou moins, |+2 Cartes|.//---//Quand un autre joueur joue une//Attaque, vous pouvez d'abord jouer//cette carte depuis votre main.";
...
FrenchCardTexts[CardNames.WITCHSHUT] = "|+4 Cartes|//Défaussez 2 cartes, dévoilées.//Si les deux sont des Actions,//tous vos adversaires//reçoivent une Malédiction.";
